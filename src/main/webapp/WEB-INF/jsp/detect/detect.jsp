                ...
                <div class="col-xs-12">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h5 class="box-title">Game Detection</h5>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            ...
                            <table id="fooTable" class="table" data-paging="true"
                                   data-show-toggle="true"
                                   data-toggle-column="last"
                                   data-filter-filters='[{"columns":[0, 1]}]'
                                   data-filtering='true'>
                                <thead>
                                <tr>
                                    <th data-breakpoints="xs sm">Date</th>
                                    <th>Game Code / App Id</th>
                                    <th>Source</th>
                                </tr>
                                </thead>
                                <tbody>
...
<script src="${cp}/resources/pagejs/detect.js"></script>
